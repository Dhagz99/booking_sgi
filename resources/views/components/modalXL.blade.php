<div id="{{ $id }}" tabindex="-1" 
    class="fixed inset-0 z-50 hidden flex justify-center items-center w-full p-4 overflow-x-hidden overflow-y-auto bg-transparent bg-opacity-0 backdrop-brightness-100">
    <!-- Backdrop -->
    <div class="absolute inset-0 bg-black opacity-50"></div>

    <!-- Modal container -->
    <div class="relative w-full max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-7xl max-h-[90vh] bottom-[3%] animate-slide-down">
        <!-- Modal content -->
